...
public enum Parameters {
	...
	V1_SUB_V2(18, "V1-V2", ParametersConst.VOLUME, "м3", 11),
	V3_SUB_V4(19, "V3-V4", ParametersConst.VOLUME, "м3", 14),
	M1_SUB_M2(20, "M1-M2", ParametersConst.WEIGHT, "т", 17),
	M3_SUB_M4(21, "M3-M4", ParametersConst.WEIGHT, "т", 20),
	T1_SUB_T2(22, "T1-T2", ParametersConst.TEMP, "°C", 5),
	T3_SUB_T4(23, "T3-T4", ParametersConst.TEMP, "°C", 8),
	ERROR_CODE(24, "ОШ",ParametersConst.ERROR,"код", 27),
	ERROR_TIME(29, "ВОС",ParametersConst.TIME,"час", 29),
