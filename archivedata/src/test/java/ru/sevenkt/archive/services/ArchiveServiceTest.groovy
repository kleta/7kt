...
class ArchiveServiceTest extends  Specification{
	...
	def "������ �������� �����"(){
		...
		for(Integer i : 0..15){
			...
			println "${record.getDate()} ����� ${record.volume1} er1 ${record.errorChannel1} er2 ${record.errorChannel2} t1 ${record.timeError1} t2 ${record.timeError2}"
			if(month%12==0){
				year++
				month=0
			}
...
//	}
	...
	def "������ ������� �����"(){
		...
		while (startDay.isBefore(endDate)){
			...
			println "${record.getDateTime()} ����� ${roundVol1} er1 ${record.errorChannel1} er2 ${record.errorChannel2}"
			startDay=startDay.plusHours(1)
		}
	}

	def "��������� �������� � ������� ������ �� ���� 2016-01-28T14:00:00"(){
		given:		
