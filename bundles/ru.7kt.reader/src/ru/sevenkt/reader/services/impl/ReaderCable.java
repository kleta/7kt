...
public class ReaderCable extends Reader{

	

	private int baudRate;

	public ReaderCable(String port, int rate) {
		super(port);
		baudRate = rate;
	}
	...
	public byte[] readCurrentData() throws Exception {
		...
		while (i < 10) {
			...
			Thread.sleep(300);
			logWrite.info("Length: " + readCurrentDataCommand.length + ", Data: " + HexUtils.bytesToHex(readCurrentDataCommand));
