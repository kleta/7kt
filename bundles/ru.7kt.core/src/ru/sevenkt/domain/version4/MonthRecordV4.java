...
public class MonthRecordV4 implements IMonthRecord{
	...
	public MonthRecordV4(byte[] monthRecordData) throws Exception {
	...
	public String toString() {
		return "MonthRecordV4 [formulaNum=" + formulaNum + ", year=" + year + ", month=" + month + ", day=" + day
				+ ", hour=" + hour + ", workHour=" + workHour + ", volume1=" + volume1 + ", energy1=" + energy1
				+ ", weight1=" + weight1 + ", errorChannel1=" + errorChannel1 + ", errorChannel2=" + errorChannel2
				+ ", timeError1=" + timeError1 + ", timeError2=" + timeError2 + "]";
	}
