...
public class DayRecordV4 implements Cloneable, IDayRecord {
	...
	@Address(value = 12)
	@Length(value = 1)
	@Parameter(Parameters.AVG_P3)
	private int avgPressure3;
	
	@Address(value = 13)
	@Length(value = 1)
	@Parameter(Parameters.AVG_P4)
	private int avgPressure4;
	...
	private DayRecordV4 prevDayRecord;

	public DayRecordV4(byte[] dayRecordData) throws Exception {
		data = dayRecordData;
		init();
	}
	...
	public DayRecordV4 minus(DayRecordV4 dr1) throws CloneNotSupportedException {
		DayRecordV4 dr2 = (DayRecordV4) this.clone();
		dr2.data = null;
	...
	public boolean equalsValues(DayRecordV4 other) {
	...
	public String toString() {
		return "DayRecordV4 [avgTemp1=" + avgTemp1 + ", avgPressure4=" + avgPressure4 + ", volume1=" + volume1
	...
	public void setPrevDayRecord(IDayRecord record) {
		prevDayRecord=(DayRecordV4) record;		
	}
