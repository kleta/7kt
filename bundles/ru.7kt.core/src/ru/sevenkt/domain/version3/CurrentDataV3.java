...
@Length(value = 48)
public class CurrentDataV3 implements ICurrentData{
	...
	public CurrentDataV3(byte[] data) throws Exception {
		this.data = data;
		init();
	}
	...
	public String toString() {
		return "CurrentDataV3 [year=" + year + ", month=" + month + ", day=" + day + ", hour=" + hour + ", workHour="
				+ workHour + ", volume1=" + volume1 + ", volume2=" + volume2 + ", volume3=" + volume3 + ", volume4="
				+ volume4 + ", energy1=" + energy1 + ", energy2=" + energy2 + ", weight1=" + weight1 + ", weight2="
				+ weight2 + ", weight3=" + weight3 + ", weight4=" + weight4 + "]";
	}
