...
public class DayRecordV3 implements Cloneable, IDayRecord {
	...
	private DayRecordV3 prevDayRecord;
	...
	public DayRecordV3(byte[] dayRecordData) throws Exception {
		data = dayRecordData;
		init();
	}
	...
	public DayRecordV3 minus(DayRecordV3 dr1) throws CloneNotSupportedException {
		DayRecordV3 dr2 = (DayRecordV3) this.clone();
		dr2.data = null;
	...
	public boolean equalsValues(DayRecordV3 other) {
	...
	public void setPrevDayRecord(IDayRecord record) {
		prevDayRecord=(DayRecordV3) record;
